...
(function() {
    ...
    this.$getScope = function(editor) {
        ...
        if (scope === "markdown" || scope === "html" || scope === "php") {
...
AceEmmetEditor.prototype = {
    ...
    getSyntax: function() {
        ...
        if (syntax == "markdown" || syntax == "html" || syntax == "php") {
...
exports.isSupportedMode = function(mode) {
    ...
    var id = mode.$id || mode;
    return /css|less|scss|sass|stylus|markdown|html|php|twig|ejs|handlebars/.test(id);
};
