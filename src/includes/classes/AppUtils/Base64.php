...
class Base64 extends Classes\AbsBase
{
    ...
    public function urlSafeEncode(string $string, array $url_unsafe_chars = array('+', '/'), array $url_safe_chars = array('-', '_'), string $trim_padding_chars = '='): string
    {
        ...
        $base64_url_safe = isset($trim_padding_chars[0]) ? $this->Utils->Trim->r($base64_url_safe, $trim_padding_chars) : $base64_url_safe;
    ...
    {
        $string = isset($trim_padding_chars[0]) ? $this->Utils->Trim->r($base64_url_safe, $trim_padding_chars) : $base64_url_safe;
