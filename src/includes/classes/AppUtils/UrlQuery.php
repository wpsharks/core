 ...
 */
class UrlQuery extends Classes\AbsBase implements Interfaces\UrlConstants, Interfaces\HtmlConstants
{
    /**
    ...
    {
        $url_uri_qsl = $this->Utils->UrlParse($url_uri_qsl);
        ...
        $url_uri_qsl          = $this->Utils->UrlParse->un($url_uri_qsl);
