...
class Html2Text extends Classes\Core\Base\Core implements Interfaces\HtmlConstants
{
    ...
    public function __invoke($value, array $args = [])
    {
        ...
        $default_args = [
            ...
            'maybe_inject_eol_after_tags' => $this::HTML_MAYBE_BLOCK_TAGS,
        ];
        ...
        $maybe_inject_eol_after_tags            = (array) $args['maybe_inject_eol_after_tags'];
        $maybe_inject_eol_after_tags_regex_frag = implode('|', $maybe_inject_eol_after_tags);
